...
Trend Analysis: Understanding evolving customer behavior
...
Identifying low-performing and high-performing categories
...
Electronics led product quantity (9,343 units), while Grocery recorded the lowest.

Electronics generated the highest revenue ($2,313,907.90).

Fashion recorded the highest number of orders.

Electronics incurred the highest shipping cost.
...
Grocery category shows weak revenue performance.

Customer preference is strongly aligned with Electronics and Fashion.
...
The Central region consistently records the lowest profit margin.
...
Investigate low-performing categories and improve marketing strategies.

Address the decline in profit margin observed in 2025.
